...
Heatmap(ct_heatmap_data_relative)
```
...
hm_plot <- grid.grabExpr(draw(Heatmap(ct_heatmap_data_relative, 
                                      col = col_fun,
                                      show_row_dend = FALSE,
                                      show_row_names = FALSE,heatmap_legend_param = list(title="LogFC"))))

plot_grid(pca_plot,hm_plot,nrow = 1, rel_widths = c(0.5,0.5))
ggsave2("figures/pca_hm.png", width = 12,height = 8)
```
