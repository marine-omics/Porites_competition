...
upset(DE_174_database, sets= c('GPCRs',
                       "Sensory.Nervous","Muscle","Toxins","BEHAVIOUR"), 
      order.by= 'freq', 
      keep.order= TRUE,
      ...
      text.scale =1) 
#Cellular Stress
upset(DE_174_database, sets= c("CELLULAR.STRESS","Ubiquitination","Apoptosis","Mucus","Antioxidants"), 
         order.by= 'freq', 
         keep.order= TRUE,
         sets.bar.color("orange"), 
         point.size=2,
...
#RESISTING
upset(DE_174_database, sets= c("RESISTING","Authophagy","Immunity", "Apoptosis"), 
         order.by= 'freq', 
         keep.order= TRUE,
         sets.bar.color("orange"), 
         point.size=2,
