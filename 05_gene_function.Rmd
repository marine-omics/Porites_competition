...
#BEHAVIOUR
upset(DE_174_database, sets= c('GPCRs',
                       "Sensory.Nervous","Muscle","BEHAVIOUR"), 
      order.by= 'freq', 
      keep.order= TRUE,
      ...
      text.scale =1) 
#Cellular Stress
upset(DE_174_database, sets= c("CELLULAR.STRESS","Ubiquitination","Apoptosis","Immunity","Mucus","Toxins","Antioxidants"), 
         order.by= 'freq', 
         keep.order= TRUE,
         sets.bar.color("orange"), 
         point.size=2,
...
#RESISTING
upset(DE_174_database, sets= c("RESISTING","Apoptosis","Authophagy","Immunity"), 
         order.by= 'freq', 
         keep.order= TRUE,
         sets.bar.color("orange"), 
         point.size=2,
