...
DE_174_database$log2FoldChange <- as.numeric(DE_174_database$log2FoldChange)
...
```{r}
CS_IS<- DE_174_database %>% 
  select("cluster_id", "Toxins.defense","Apoptosis",'Immune.activation',
...
```{r}
NS_BEH<- DE_174_database %>% 
  select("cluster_id", "Behaviour","Muscle","GPCRs","Food.related",
